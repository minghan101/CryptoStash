...
export const navbarBrand = "CryptoStash News";
...
export const navs = [
  ...
  { nav: "Crypto", page: "/categories/Crypto" },
...
export const router = [
  ...
  { path: "/categories/Crypto", key: "Crypto", category: "Crypto", country: "us" },
...
export const summary = "Channel and Published at";
